...
const placeholderColor =  useThemeColor({ light: lightColor, dark: darkColor }, 'placeholderTextColor');

return <DefaultTextInput style={[{ backgroundColor, color: textColor,}, style]}
